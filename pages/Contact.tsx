          ...
          <div>
            ...
            <div className="space-y-8">
              <ContactInfoItem 
                ...
                label="E-mail"
                value="contato@lobodigital.com.br"
              />
              <ContactInfoItem 
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-brand-dark border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-blue transition-colors"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-brand-dark border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-brand-blue transition-colors resize-none"
                  ></textarea>
                </div>
                ...
                <div className="flex flex-col gap-4">
                  <button 
                    type="submit"
                    className="w-full py-4 bg-brand-blue hover:bg-brand-blue/90 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 group"
                  >
                    Enviar Mensagem
                ...
                {submitted && (
                  <div className="bg-green-500/10 text-green-500 p-4 rounded-xl text-center text-sm font-bold border border-green-500/20">
